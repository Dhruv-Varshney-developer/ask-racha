...
export function WelcomeScreen({ status, suggestions, setInput }: WelcomeScreenProps) {
    return (
        <div className="flex-1 flex items-center justify-center p-6">
            <div className="text-center max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-center gap-2 mb-8">
                    ...
                    <p className="text-xl lg:text-2xl text-muted-foreground">Your intelligent Storacha documentation assistant</p>
                </div>

                {status && status.documents_loaded && status.documents_loaded > 0 ? (
                    <div className="space-y-4">
                        <p className="text-muted-foreground mb-8">Choose a question to get started, or ask your own:</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
                            {suggestions.map((suggestion, idx) => (
                                ...
                                >
                                    <div className="text-sm lg:text-base font-medium">{suggestion}</div>
                                </button>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="bg-card rounded-lg border border-border p-8 shadow-sm max-w-md mx-auto">
                        <p className="text-muted-foreground mb-4">Please load the documents to get started</p>
