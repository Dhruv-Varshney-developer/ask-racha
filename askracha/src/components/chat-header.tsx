...
export function ChatHeader({ onMenuClick, status, isInitialized }: ChatHeaderProps) {
    return (
            ...
            <div className="flex items-center justify-between px-4 lg:px-6 py-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl lg:text-2xl font-semibold text-foreground">AskRacha</h1>
                            <p className="text-sm text-muted-foreground hidden sm:block">AI Documentation Assistant</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary text-secondary-foreground border">
                        {isInitialized && status?.documents_loaded && status.documents_loaded > 0 ? (
                            <>
