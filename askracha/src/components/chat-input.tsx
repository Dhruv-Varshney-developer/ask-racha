...
export function ChatInput({ input, setInput, handleSubmit, isLoading, canSubmit, status }: ChatInputProps) {
    ...
    return (
        <div className="p-4 lg:p-6 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-t">
            <form onSubmit={handleSubmit} className="flex gap-3 lg:gap-4 max-w-4xl mx-auto">
                <div className="flex-1 relative">
                    <textarea
                        ...
                        placeholder={canSubmit ? "Ask me anything about Storacha..." : "Please load documents first..."}
